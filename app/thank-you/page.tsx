...
export default function ThankYouPage() {
  return (
    <main className="min-h-screen bg-[#faf9f7] flex flex-col">
      ...
      {/* Google Ads Conversion Event Script - Lead Form - Salem */}
      <Script id="google-ads-conversion-salem" strategy="afterInteractive">
        {`
          gtag('event', 'conversion', {
            'send_to': 'AW-17425479208/Q0YwCKudssEcEKjsjvVA',
            'value': 1.0,
            'currency': 'INR'
          });
        `}
